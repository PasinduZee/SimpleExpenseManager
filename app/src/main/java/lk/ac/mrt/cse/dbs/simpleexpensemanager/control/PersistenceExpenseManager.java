...
public class PersistenceExpenseManager extends ExpenseManager {
    ...
    public PersistenceExpenseManager() {
        setup();
    }
    ...
    public void setup() {
        ...
        DataBase db =new DataBase(AppContext.getContext());
        setTransactionsDAO(new PersistanceTransactionDAO(db));
        setAccountsDAO(new PersistanceAccountDAO(db));
        // dummy data
